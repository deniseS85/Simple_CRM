  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [
        ...
        FormsModule, MatFormFieldModule, MatDatepickerModule, MatNativeDateModule, MatInputModule, BrowserAnimationsModule
      ],
      declarations: [DialogAddUserComponent],
      providers: [
        { provide: MatDialogRef, useClass: MatDialogRefMock },
        { provide: MAT_DIALOG_DATA, useValue: { user: { firstName: 'John', lastName: 'Doe', birthDate: '2000-01-01', email: 'test@example.com' } } }
      ]
    })
    .compileComponents();
